				...
				>
					...
					>
						...
						>
							...
							{/* <h2 className="text-center text-start text-accent font-anta mt-[-40px]">
								Level Up Beirut{" "}
							</h2> */}
						...
						<ul className="flex flex-col gap-4">
							<li className="flex items-center gap-4">
								...
								<span>Hamra, Beirut</span>
							</li>
							<li className="flex items-center gap-4">
								<FaPhoneAlt className="text-xl text-accent" />
								<span>+961 1 445 330 | 1 350 588</span>
							</li>
							<li>
								<Link
			...
			<div className="text-white border-t border-white/20 py-20 mt-14">
				<div className="container mx-auto h-full">
					<div className="flex items-center justify-between h-full">
						<span>
							&copy; Copyright {currentYear} PEAK Fitness{" "}
						</span>
